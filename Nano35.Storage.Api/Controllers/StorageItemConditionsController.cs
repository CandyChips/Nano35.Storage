...
namespace Nano35.Storage.Api.Controllers
{
        ...
        ControllerBase
    {
        ...
        {
            return await 
                new ValidatedPipeNode<GetAllStorageItemConditionsHttpQuery, IActionResult>(
                        _services.GetService(typeof(IValidator<GetAllStorageItemConditionsHttpQuery>)) as IValidator<GetAllStorageItemConditionsHttpQuery>, 
                        new ConvertedGetAllStorageItemConditionsOnHttpContext(
