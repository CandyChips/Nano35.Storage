...
{
    public class ConvertedGetAllArticleModelsOnHttpContext : 
        PipeInConvert
    ...
    {
        public ConvertedGetAllArticleModelsOnHttpContext(IPipeNode<IGetAllArticlesModelsRequestContract, IGetAllArticlesModelsResultContract> next) :
            base(next) {}
