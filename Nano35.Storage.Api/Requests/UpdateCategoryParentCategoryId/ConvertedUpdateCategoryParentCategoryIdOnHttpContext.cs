...
{
    public class ConvertedUpdateCategoryParentCategoryIdOnHttpContext : 
        PipeInConvert
    ...
    {
        public ConvertedUpdateCategoryParentCategoryIdOnHttpContext(IPipeNode<IUpdateCategoryParentCategoryIdRequestContract, IUpdateCategoryParentCategoryIdResultContract> next) :
            base(next) {}
