...
{
    public class CanonicalizedGetAllArticleBrandsRequest : 
        PipeInConvert
    ...
    {
        public CanonicalizedGetAllArticleBrandsRequest(IPipeNode<IGetAllArticlesBrandsRequestContract, IGetAllArticlesBrandsResultContract> next) :
            base(next) {}
