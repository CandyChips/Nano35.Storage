...
{
    public class ConvertedCreateArticleOnHttpContext : 
        PipeInConvert
    ...
    {
        public ConvertedCreateArticleOnHttpContext(IPipeNode<ICreateArticleRequestContract, ICreateArticleResultContract> next) :
            base(next) {}
