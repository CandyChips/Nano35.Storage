...
{
    public class ConvertedCreateComingOnHttpContext : 
        PipeInConvert
    ...
    {
        public ConvertedCreateComingOnHttpContext(IPipeNode<ICreateComingRequestContract, ICreateComingResultContract> next) :
            base(next) {}
