...
{
    public class ConvertedCreateMoveOnHttpContext : 
        PipeInConvert
        <CreateMoveHttpBody, 
            IActionResult,
    ...
    {
        public ConvertedCreateMoveOnHttpContext(IPipeNode<ICreateMoveRequestContract, ICreateMoveResultContract> next) :
            base(next) {}
