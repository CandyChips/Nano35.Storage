...
{
    public class ConvertedGetArticleByIdOnHttpContext : 
        PipeInConvert
    ...
    {
        public ConvertedGetArticleByIdOnHttpContext(IPipeNode<IGetArticleByIdRequestContract, IGetArticleByIdResultContract> next) :
            base(next) {}
