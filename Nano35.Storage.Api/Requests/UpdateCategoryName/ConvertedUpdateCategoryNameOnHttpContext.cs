...
{
    public class ConvertedUpdateCategoryNameOnHttpContext : 
        PipeInConvert
    ...
    {
        public ConvertedUpdateCategoryNameOnHttpContext(IPipeNode<IUpdateCategoryNameRequestContract, IUpdateCategoryNameResultContract> next) :
            base(next) {}
