...
{
    public class ConvertedCreateStorageItemOnHttpContext : 
        PipeInConvert
    ...
    {
        public ConvertedCreateStorageItemOnHttpContext(IPipeNode<ICreateStorageItemRequestContract, ICreateStorageItemResultContract> next) :
            base(next) {}
