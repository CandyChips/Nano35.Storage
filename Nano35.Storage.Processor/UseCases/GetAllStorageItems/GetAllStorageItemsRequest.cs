...
{
    public class GetAllStorageItemsRequest : EndPointNodeBase<IGetAllStorageItemsRequestContract, IGetAllStorageItemsResultContract>
    {
            ...
            var result = await _context
                ...
                .Select(a => 
                    ...
                    {Id = a.Id,
                     ...
                     Images = (new GetImagesOfStorageItem(_bus,new GetImagesOfStorageItemRequestContract() {StorageItemId = a.Id}).GetResponse()
