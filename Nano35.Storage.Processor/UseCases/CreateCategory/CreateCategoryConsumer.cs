...
{
    public class CreateCategoryConsumer : IConsumer<ICreateCategoryRequestContract>
    {
        private readonly IServiceProvider _services;
        public CreateCategoryConsumer(IServiceProvider services) => _services = services;
        public async Task Consume(ConsumeContext<ICreateCategoryRequestContract> context)
        {
            var result =
                await new LoggedUseCasePipeNode<ICreateCategoryRequestContract, ICreateCategoryResultContract>(
                        ...
                        new TransactedUseCasePipeNode<ICreateCategoryRequestContract, ICreateCategoryResultContract>(
